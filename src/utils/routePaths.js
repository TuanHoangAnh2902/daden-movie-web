...
export const toMovieCategoryPath = (categorySlug, page = 1) =>
	`/movies/category/${encodeSegment(categorySlug)}?page=${page}`

export const toMovieCountryPath = (countrySlug, page = 1) =>
	`/movies/country/${encodeSegment(countrySlug)}?page=${page}`
